...
def download_and_organize_png_files(url, parent_dir):
    ...
    if response.status_code == 200:
        ...
        for table in tables:
            # Find all <td> elements that contain the specific text to find in the <a> tag
            td_elements = table.find_all('td', string=re.compile(r'specific text to find in the <a> tag', re.IGNORECASE))
...
parent_directory = 'file_pokemon7'
